...
import 'package:chat_app/Resources/Managers/fonts_manager.dart';
import 'package:chat_app/Resources/Managers/styles_manager.dart';
...
/**************************** BRIGHT THEME ****************************** */
  return ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      centerTitle: true,
      elevation: AppSize.s8,
      titleTextStyle: getBoldStyle(color: ColorManager.White, fontsize: 18.0),
    ),
